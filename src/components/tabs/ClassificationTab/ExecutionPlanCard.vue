  ...
  >
    ...
    <div class="">
      <div class="flex items-center gap-3 mb-3">
        <h4 class="text-gradient-primary font-bold md:text-base">
          {{ project.title }}
        </h4>
        <span
          class="px-3.5 py-1.5 rounded-full border border-theme-accent-secondary text-theme-accent-secondary bg-theme-accent-secondary-bg shrink-0"
        >
          {{ project.status }}
        </span>
      </div>
    ...
    <div class="flex flex-col items-end gap-3">
      <!-- Link Project Button -->
      <BaseButton
        class="py-2 px-5 bg-gradient-primary flex items-center gap-2 text-theme-text w-fit"
