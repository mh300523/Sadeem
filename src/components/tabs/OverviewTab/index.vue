  ...
  <div class="grid grid-cols-1 lg:grid-cols-12 gap-6">
    ...
    <div class="lg:col-span-9">
      ...
      <BaseBox class="rounded-[20px] p-4 sm:p-6 mb-6 border-subtle">
        ...
        <p
          class="text-theme-text text-xs md:text-sm leading-relaxed text-justify font-normal"
        >
    ...
    <div class="lg:col-span-3">
      <BaseBox class="rounded-[20px] p-3 border-subtle">
        ...
        <div class="border-b border-[#A9A9A9]/40 border-dashed">
          <h4 class="text-theme-text/50 text-xs tracking-wide uppercase mb-3">
        ...
        <BaseTagList
          ...
          :classes="{
            pill: 'bg-[#FF6B35]/10 text-theme-text/76',
        ...
        <BaseTagList
          ...
          class="border-b border-[#A9A9A9]/40 border-dashed"
          :classes="{
            pill: 'bg-[#3B82F6]/10 text-theme-text/76',
        ...
        <BaseTagList
          ...
          class="border-b border-[#A9A9A9]/40 border-dashed"
          :classes="{
            pill: 'bg-[#8B5CF6]/10 text-theme-text/76',
        ...
        <div class="flex items-center justify-between py-3">
          <span class="text-theme-text/50 text-xs tracking-wide uppercase">
